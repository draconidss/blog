...
/*  configureWebpack: () => {
  ...
  themeConfig: {
    logo: "https://cdn.jsdelivr.net/gh/lifealsoisgg/Blog@gh-pages/logo.png",
    baseLang: "zh-CN",
    ...
    sidebar: {
...

      {
        ...
        icon: "creative",
        prefix: "Spring/",
        children: ["Spring","Spring-annotation","Spring-error&hole","Spring-Interview",
        {
          title: "Spring Boot",
          icon: "creative",
          prefix: "SpringBoot/",
